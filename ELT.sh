...
aws emr create-cluster --profile default --security-configuration EMRSecConfig --applications Name=Spark --tags 'VPC=Default' 'name=poly-covid' 'Environment=production' 'Name=poly-covid' --ec2-attributes '{"KeyName":"gerard-bartolome-dev","AdditionalSlaveSecurityGroups":["sg-933774ce"],"InstanceProfile":"admin","SubnetId":"subnet-01c6a60a78a29d1da","EmrManagedSlaveSecurityGroup":"sg-933774ce","EmrManagedMasterSecurityGroup":"sg-933774ce","AdditionalMasterSecurityGroups":["sg-933774ce"]}' --release-label emr-5.30.0 --log-uri 's3n://poly-hadoop/' --instance-groups '[{"InstanceCount":1,"EbsConfiguration":{"EbsBlockDeviceConfigs":[{"VolumeSpecification":{"SizeInGB":20,"VolumeType":"io1","Iops":1000},"VolumesPerInstance":1}],"EbsOptimized":true},"InstanceGroupType":"MASTER","InstanceType":"c5.xlarge","Name":"Master - 1"},{"InstanceCount":2,"EbsConfiguration":{"EbsBlockDeviceConfigs":[{"VolumeSpecification":{"SizeInGB":20,"VolumeType":"io1","Iops":1000},"VolumesPerInstance":3}]},"InstanceGroupType":"CORE","InstanceType":"c5.xlarge","Name":"Core - 2"}]' --configurations '[{"Classification":"spark","Properties":{"authenticate":"true","maximizeResourceAllocation":"true"}},
